...
class MockQueryOrchestrator:
    ...
    async def process_angle(self, angle: str) -> Dict[str, Any]:
        """Process a single analytical angle through Stravito API - MOCK VERSION"""
        try:
            ...
            # Mock message data
            mock_content = f"Mock response for: {angle}. This is a simulated response from the Stravito API that would normally contain detailed information about the query angle. The response includes relevant data, insights, and analysis that would be provided by the actual API service."
...
"""
    ...
    async def orchestrate_query(self, query: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print("🔄 MOCK: Step 2 - Processing angles through Stravito API...")
