...
st.set_page_config(
    page_title="XXXX Query Orchestrator",
    page_icon="🔍",
    layout="wide",
...
def main():
    ...
    # Header
    st.title("🔍 XXXX Query Orchestrator")
    st.markdown("""
    This application processes your queries through multiple analytical angles using the XXXX API, 
    ...
    <div style='text-align: center; color: #666;'>
        <p>XXXX Query Orchestrator | Powered by FastAPI, Streamlit, and Azure OpenAI</p>
    </div>
